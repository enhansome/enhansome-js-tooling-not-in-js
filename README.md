...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,897 | 🐛 220 | 🌐 Rust | 📅 2026-09-12 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,191 | 🐛 438 | 🌐 Rust | 📅 2026-09-12 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,962 | 🐛 861 | 🌐 Rust | 📅 2026-09-11 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,962 | 🐛 861 | 🌐 Rust | 📅 2026-09-11 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,680 | 🐛 919 | 🌐 JavaScript | 📅 2026-09-11 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,553 | 🐛 210 | 🌐 Rust | 📅 2026-09-12 - Embeddable and experimental Javascript engine, written in Rust.
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,079 | 🐛 13 | 🌐 Rust | 📅 2026-09-12 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,831 | 🐛 246 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,409 | 🐛 22 | 🌐 Rust | 📅 2026-09-11 – A multi-language version and dependency manager, written in Rust.
