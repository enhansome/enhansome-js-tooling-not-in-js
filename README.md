...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,886 | 🐛 224 | 🌐 Rust | 📅 2026-09-04 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,195 | 🐛 417 | 🌐 Rust | 📅 2026-09-04 - TypeScript/JavaScript compiler in Rust.
...
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,678 | 🐛 916 | 🌐 JavaScript | 📅 2026-09-03 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,531 | 🐛 202 | 🌐 Rust | 📅 2026-09-01 - Embeddable and experimental Javascript engine, written in Rust.
* [Goja](https://github.com/dop251/goja) ⭐ 7,072 | 🐛 29 | 🌐 Go | 📅 2026-09-03 - ECMAScript/JavaScript engine, written in Go .
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,058 | 🐛 15 | 🌐 Rust | 📅 2026-09-04 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,785 | 🐛 243 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,404 | 🐛 25 | 🌐 Rust | 📅 2026-09-04 – A multi-language version and dependency manager, written in Rust.
