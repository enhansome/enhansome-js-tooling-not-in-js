...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,869 | 🐛 268 | 🌐 Rust | 📅 2026-08-24 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,185 | 🐛 417 | 🌐 Rust | 📅 2026-08-24 - TypeScript/JavaScript compiler in Rust.
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,003 | 🐛 21 | 🌐 Rust | 📅 2026-08-24 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,682 | 🐛 241 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,397 | 🐛 22 | 🌐 Rust | 📅 2026-08-24 – A multi-language version and dependency manager, written in Rust.
