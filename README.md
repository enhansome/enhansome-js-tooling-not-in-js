...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,862 | 🐛 273 | 🌐 Rust | 📅 2026-08-19 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,179 | 🐛 412 | 🌐 Rust | 📅 2026-08-19 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-19 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-19 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,672 | 🐛 917 | 🌐 JavaScript | 📅 2026-08-18 - in Java.
...
* [Goja](https://github.com/dop251/goja) ⭐ 7,053 | 🐛 31 | 🌐 Go | 📅 2026-08-06 - ECMAScript/JavaScript engine, written in Go .
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 30,933 | 🐛 19 | 🌐 Rust | 📅 2026-08-18 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,614 | 🐛 240 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,393 | 🐛 23 | 🌐 Rust | 📅 2026-08-18 – A multi-language version and dependency manager, written in Rust.
