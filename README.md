...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,867 | 🐛 272 | 🌐 Rust | 📅 2026-08-20 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,179 | 🐛 415 | 🌐 Rust | 📅 2026-08-20 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-20 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-20 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,673 | 🐛 917 | 🌐 JavaScript | 📅 2026-08-20 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,488 | 🐛 259 | 🌐 Rust | 📅 2026-08-15 - Embeddable and experimental Javascript engine, written in Rust.
* [Goja](https://github.com/dop251/goja) ⭐ 7,053 | 🐛 35 | 🌐 Go | 📅 2026-08-06 - ECMAScript/JavaScript engine, written in Go .
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 30,956 | 🐛 15 | 🌐 Rust | 📅 2026-08-20 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,633 | 🐛 240 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,395 | 🐛 27 | 🌐 Rust | 📅 2026-08-20 – A multi-language version and dependency manager, written in Rust.
...
* [Volt](https://github.com/voltpkg/volt) ⭐ 925 | 🐛 12 | 🌐 Rust | 📅 2026-05-29 - JavaScript Package Manager, written in Rust.
