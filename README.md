...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,919 | 🐛 237 | 🌐 Rust | 📅 2026-09-25 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,202 | 🐛 430 | 🌐 Rust | 📅 2026-09-25 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,965 | 🐛 864 | 🌐 Rust | 📅 2026-09-25 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,965 | 🐛 864 | 🌐 Rust | 📅 2026-09-25 in Rust.
...
* [Goja](https://github.com/dop251/goja) ⭐ 7,112 | 🐛 33 | 🌐 Go | 📅 2026-09-25 - ECMAScript/JavaScript engine, written in Go .
...
* [Deno Lint](https://github.com/denoland/deno_lint) ⭐ 1,584 | 🐛 167 | 🌐 Rust | 📅 2026-09-25
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,137 | 🐛 11 | 🌐 Rust | 📅 2026-09-25 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,959 | 🐛 248 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,423 | 🐛 24 | 🌐 Rust | 📅 2026-09-25 – A multi-language version and dependency manager, written in Rust.
