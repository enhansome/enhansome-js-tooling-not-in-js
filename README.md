...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,868 | 🐛 266 | 🌐 Rust | 📅 2026-08-24 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,184 | 🐛 417 | 🌐 Rust | 📅 2026-08-24 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-24 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-24 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,675 | 🐛 916 | 🌐 JavaScript | 📅 2026-08-22 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,496 | 🐛 262 | 🌐 Rust | 📅 2026-08-22 - Embeddable and experimental Javascript engine, written in Rust.
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,002 | 🐛 21 | 🌐 Rust | 📅 2026-08-24 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,681 | 🐛 239 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,398 | 🐛 22 | 🌐 Rust | 📅 2026-08-23 – A multi-language version and dependency manager, written in Rust.
