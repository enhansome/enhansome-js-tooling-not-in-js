...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,878 | 🐛 269 | 🌐 Rust | 📅 2026-08-30 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,190 | 🐛 413 | 🌐 Rust | 📅 2026-08-28 - TypeScript/JavaScript compiler in Rust.
...
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,679 | 🐛 917 | 🌐 JavaScript | 📅 2026-08-28 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,517 | 🐛 231 | 🌐 Rust | 📅 2026-08-30 - Embeddable and experimental Javascript engine, written in Rust.
* [Goja](https://github.com/dop251/goja) ⭐ 7,062 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - ECMAScript/JavaScript engine, written in Go .
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,035 | 🐛 17 | 🌐 Rust | 📅 2026-08-30 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,733 | 🐛 241 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,404 | 🐛 24 | 🌐 Rust | 📅 2026-08-30 – A multi-language version and dependency manager, written in Rust.
