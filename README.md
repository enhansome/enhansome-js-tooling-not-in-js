...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,860 | 🐛 274 | 🌐 Rust | 📅 2026-08-18 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,177 | 🐛 409 | 🌐 Rust | 📅 2026-08-18 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-18 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-18 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,673 | 🐛 917 | 🌐 JavaScript | 📅 2026-08-18 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,486 | 🐛 258 | 🌐 Rust | 📅 2026-08-15 - Embeddable and experimental Javascript engine, written in Rust.
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 30,907 | 🐛 21 | 🌐 Rust | 📅 2026-08-18 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,600 | 🐛 239 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,392 | 🐛 23 | 🌐 Rust | 📅 2026-08-18 – A multi-language version and dependency manager, written in Rust.
