...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,863 | 🐛 278 | 🌐 Rust | 📅 2026-08-17 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,177 | 🐛 411 | 🌐 Rust | 📅 2026-08-17 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-17 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-17 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,674 | 🐛 917 | 🌐 JavaScript | 📅 2026-08-17 - in Java.
* [Paperclip](https://paperclip.dev/) - Presentational component compiler in Rust + WASM.

## Engines

* [Boa](https://github.com/boa-dev/boa) ⭐ 7,486 | 🐛 255 | 🌐 Rust | 📅 2026-08-15 - Embeddable and experimental Javascript engine, written in Rust.
* [Goja](https://github.com/dop251/goja) ⭐ 7,052 | 🐛 31 | 🌐 Go | 📅 2026-08-06 - ECMAScript/JavaScript engine, written in Go .
...
* [RSLint](https://github.com/rslint/rslint) ⭐ 2,731 | 🐛 41 | 🌐 Rust | 📅 2023-03-05 - Extremely fast JavaScript and TypeScript linter, written in Rust. (WIP)
* [Deno Lint](https://github.com/denoland/deno_lint) ⭐ 1,585 | 🐛 167 | 🌐 Rust | 📅 2026-07-23
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 30,904 | 🐛 22 | 🌐 Rust | 📅 2026-08-17 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,595 | 🐛 239 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,390 | 🐛 22 | 🌐 Rust | 📅 2026-08-16 – A multi-language version and dependency manager, written in Rust.
* [es-module-lexer](https://github.com/guybedford/es-module-lexer) ⭐ 1,030 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript module syntax lexer, written in C.
