...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,915 | 🐛 221 | 🌐 Rust | 📅 2026-09-22 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,206 | 🐛 441 | 🌐 Rust | 📅 2026-09-22 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,963 | 🐛 861 | 🌐 Rust | 📅 2026-09-22 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,963 | 🐛 861 | 🌐 Rust | 📅 2026-09-22 in Rust.
* [Closure Compiler](https://github.com/google/closure-compiler) ⭐ 7,686 | 🐛 918 | 🌐 JavaScript | 📅 2026-09-22 - in Java.
...
* [Goja](https://github.com/dop251/goja) ⭐ 7,110 | 🐛 32 | 🌐 Go | 📅 2026-09-17 - ECMAScript/JavaScript engine, written in Go .
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,127 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,925 | 🐛 248 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,421 | 🐛 23 | 🌐 Rust | 📅 2026-09-22 – A multi-language version and dependency manager, written in Rust.
