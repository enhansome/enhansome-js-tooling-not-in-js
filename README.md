...
* [Rspack](https://github.com/web-infra-dev/rspack) ⭐ 12,888 | 🐛 233 | 🌐 Rust | 📅 2026-09-06 – A fast web bundler (drop-in replacement for Webpack), written in Rust.

## Compilers

* [swc](https://github.com/swc-project/swc) ⭐ 34,196 | 🐛 444 | 🌐 Rust | 📅 2026-09-06 - TypeScript/JavaScript compiler in Rust.
* [Relay](https://github.com/facebook/relay) ⭐ 18,962 | 🐛 862 | 🌐 Rust | 📅 2026-09-04 - JavaScript framework for building data-driven React applications, [compiler](https://github.com/facebook/relay/tree/main/compiler) ⭐ 18,962 | 🐛 862 | 🌐 Rust | 📅 2026-09-04 in Rust.
...
* [Boa](https://github.com/boa-dev/boa) ⭐ 7,535 | 🐛 206 | 🌐 Rust | 📅 2026-09-05 - Embeddable and experimental Javascript engine, written in Rust.
...
* [Turborepo](https://github.com/vercel/turborepo) ⭐ 31,066 | 🐛 14 | 🌐 Rust | 📅 2026-09-06 - The high-performance build system for JavaScript & TypeScript codebases, written in Go, 🚧 currently being migrated to Rust ([source](https://vercel.com/blog/turborepo-migration-go-rust)).
* [Fast Node Manager (fnm)](https://github.com/Schniz/fnm) ⭐ 26,797 | 🐛 243 | 🌐 Rust | 📅 2026-07-24 - Node.js version manager, written in Rust.
...
* [Proto](https://github.com/moonrepo/proto) ⭐ 1,407 | 🐛 21 | 🌐 Rust | 📅 2026-09-05 – A multi-language version and dependency manager, written in Rust.
